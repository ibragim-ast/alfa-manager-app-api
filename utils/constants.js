...
const INCORRECT_AD_DATA = "Переданы некорректные данные при добавлении рекламы";
const AD_NOT_FOUND = "Реклама с указанным идентификатором не найдена";
const NO_RIGHTS_TO_DELETE_AD =
  "У вас недостаточно прав на удаление данной рекламы";
const EMAIL_ALREADY_REGISTERED =
  "Пользователь с таким email уже зарегистрирован";
const INCORRECT_ADD_USER_DATA =
